...
const Card = (props) => {
  ...
  function clickHandler() {
    if (likedCourses.includes(course.id)) {
      //matlb pahle se like hua pada tha
      setLikedCourses((prev) => prev.filter((cid) => (cid !== course.id)))
      toast.warning("Like removed")
    }
    else {
      //pahle se liked naha hai, isliye insert karna hai liked courses me
      if (likedCourses === 0) {
  ...
  return (
    <div className="w-[300px] bg-indigo-950 bg-opacity-80 rounded-md overflow-hidden">
